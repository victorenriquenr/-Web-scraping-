# Scraping Nature Computational Science
#
# Author Víctor Núñez
# Date: 24-04-2024
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
def Scrape(numPage): 
    ...
    for page in range(1, numPage+1):
        URL = 'https://www.nature.com/natcomputsci/research-articles?searchType=journalSearch&sort=PubDate&page='+str(count)
...
df['Topic'] = 'Computational Science'
df.to_csv('./dataset_computsci.csv', index =  False, header = True)
